...
public class PedidoMB implements Serializable {
	...
	private ClienteVO dadosCliente = new ClienteVO();
	...
	public String setDados(Integer idClient, String nomeCliente, String enderecoCliente) {
		this.dadosCliente.setId(idCliente);
		this.dadosCliente.setNome(nomeCliente);
		this.dadosCliente.setEndereco(enderecoCliente);
		this.idCliente = idClient;
		return "cadastro-pedidos.xhtml";
	}
	
	public Double getValorTodosPedidos() {
	...
	public ClienteVO getDadosCliente() {
		return dadosCliente;
	}

	public void setDadosCliente(ClienteVO dadosCliente) {
